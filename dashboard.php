  ...
  <div class="card">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="tbale-responsive text-nowrap">
...
<!-- Menampilkan table data dari tabel database -->
<?php
  $index = 1;
  ...
  ?>
    <tr>
      ...
      <!-- Modal untuk Hapus Konten Blog -->
       <div class="modal fade" id="deletePost_<?= $post['id_post']; ?>" tabindex="-1" aria-bidden="true">
